...
print("Castle dungeons - An interactive fiction game.")
...
def create_character_skill_sheet():
    ...
    You can modify your skills by rolling a 6-face die, if you want.
    ...
    """)
    modifier_choice = input("""
    Do you want to modify your skillset?
    (Remember, your skills may either DECREASE or INCREASE if you choose yes)
    1 - Yes
    2 - No
    
    > """)
    if modifier_choice == "1" or modifier_choice == "Yes":
        modify_skills()
    else:
        cls()
        print("""
...
def Scene_1():
    ...
    > """)
        if user_input == "1" or user_input == "turn left":
            ...
            print("""
            Not a valid choice, type a valid number or "turn left" / "turn right"
            """)
...
def skill_check():
    cls()
    print("A giant rock falls from the ceiling, and you have to dodge .. or you will be crashed by it!")
    print("")
    print("")
    print("""To dodge the rock, you will have to remember the numbers which come on the screen(strictly in that order)
    ...
    time.sleep(2)
    print("")
    ans1 = input("What was the second number?\n  > ")
    if int(ans1) == numbers[1]:
        print("Correct! Next question...")
        character_dexterity = character_dexterity - 1;
        ans2 = input("What was the sum of all the numbers?\n  > ")
        if int(ans2) == sum_numbers:
            character_dexterity = character_dexterity - 1;
            print(""" Correct! 
